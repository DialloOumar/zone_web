...
HELP_SECTIONS = [
    ...
    },
    {
        ...
        "steps": {
            "fr": [
                "La page « Dépenses », c'est la caisse : on y met de l'argent, et les dépenses le consomment. Le solde est affiché en haut. Tout ce qui s'y saisit est une dépense de société — il n'y a pas de flotte à choisir.",
                ...
                "Choisissez la date, puis la catégorie : « Dépense société » pour les frais du bureau, « Dépense terrain » pour ce qui est dépensé sur les chantiers.",
                "Sur une dépense terrain, un champ « Nombre de pièces » apparaît. Il est facultatif : remplissez-le quand la dépense a servi à acheter des pièces.",
                "Entrez le montant, puis le moyen de paiement et la référence.",
                "La description accepte plusieurs lignes : c'est là qu'on dit ce que la dépense recouvre.",
                "Enregistrez.",
            ],
            "en": [
                "The \"Expenses\" page is the cash box: money is paid in, and the costs spend it. The balance is at the top. Everything logged there is a company cost — there is no fleet to pick.",
                ...
                "Pick the date, then the category: \"Company expense\" for office costs, \"Field expense\" for what is spent on site.",
                "On a field expense a \"Number of parts\" field appears. It is optional: fill it in when the cost paid for parts.",
                "Enter the amount, then the payment method and reference.",
                "The description takes several lines: that is where you say what the cost covers.",
                "Save.",
            ],
        },
        "tips": {
            "fr": [
                ...
                "Le nombre de pièces est une simple mention sur la dépense — le stock de pièces garde son propre compte et n'en tient pas compte.",
                ...
                "Le rapport suit la période affichée. La page s'ouvre sur le mois en cours ; videz une date pour ouvrir ce côté, ou cliquez « Toutes périodes ».",
            ...
            "en": [
                ...
                "The part count is a note on the expense — the parts stock keeps its own count and does not read it.",
                ...
                "The report follows the period on screen. The page opens on the current month; clear one date to open that side, or click \"All periods\".",
