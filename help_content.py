    ...
    },
    {
        ...
        "steps": {
            "fr": [
                ...
                "Le véhicule ne s'affiche que si vous avez choisi un site. Une dépense sans site est une dépense de société : elle ne concerne aucune machine.",
                ...
                "Si une facture fournisseur attend d'être payée, un champ « Règle une facture » apparaît. Choisissez-la quand la caisse paie cette facture : le versement est écrit sur la facture, et vous n'avez rien d'autre à faire.",
            ...
            "en": [
                ...
                "The vehicle only appears once you have picked a site. A cost with no site is a company expense: it is for no machine.",
                ...
                "If a supplier invoice is waiting to be paid, a \"Settles an invoice\" field appears. Pick it when the box is paying that bill: the payment is written on the invoice and there is nothing else to do.",
    ...
    },
    {
        ...
        "steps": {
            "fr": [
                ...
                "« Scanner la facture » : prenez la facture en photo, puis faites glisser les 4 ronds sur les coins de la feuille. « Redresser » la remet à plat, comme un vrai scan. Choisissez « Couleur » (le cachet reste visible) ou « Noir et blanc ».",
                "Une facture de plusieurs pages : après chaque page, « Ajouter une page ». Toutes les pages sont enregistrées ensemble dans un seul PDF.",
                "Une facture reçue par e-mail est déjà un PDF : « Joindre un PDF » la range telle quelle.",
                "Un fournisseur qui vous loue des engins : cochez « Fournisseur de machines » sur sa fiche et cochez ses machines. Dans l'onglet Fournisseurs, « Saisies de ses machines » ouvre une page à son nom : seulement ses machines, un mois ou une période, les totaux d'heures et de trajets — et le bouton Imprimer sort cette liste à son nom, pour vérifier sa facture.",
                "Le bouton avec la coche (✓) ouvre les versements de la facture : tout ce qui a déjà été payé dessus, et ce qui reste.",
                "Une facture se paie en plusieurs fois si besoin. Chaque versement garde sa date, son montant et son moyen de paiement — 500 000 en espèces le 10, le reste par virement le 25.",
            ...
            "en": [
                ...
                "\"Scan the invoice\": photograph the invoice, then drag the 4 dots onto the corners of the sheet. \"Straighten\" flattens it like a real scan. Pick \"Colour\" (the stamp stays visible) or \"Black and white\".",
                "An invoice of several pages: after each page, \"Add a page\". All the pages are saved together in a single PDF.",
                "An invoice received by e-mail is already a PDF: \"Attach a PDF\" files it as it is.",
                "A supplier that leases engines to you: tick \"Machine supplier\" on its card and tick its machines. On the Suppliers tab, \"Its machines' entries\" opens a page of its own: only its machines, a month or a period, the totals of hours and trips — and the Print button gives that list under its name, to check its bill.",
                "The tick button opens the bill's payments: everything already paid on it, and what is left.",
                "A bill can be settled in several goes. Each payment keeps its own date, amount and method — 500,000 in cash on the 10th, the rest by transfer on the 25th.",
        ...
        "tips": {
            "fr": [
                "Enregistrer une facture ne sort aucun argent : c'est une dette, pas une dépense. Seuls les versements payés par la caisse touchent le solde de la caisse, et ceux-là se saisissent sur la page Dépenses.",
                "Un versement venu de la caisse s'affiche « Caisse » et ne se modifie pas depuis la facture : il faut corriger la dépense elle-même. C'est ce qui garantit que la facture et la caisse ne racontent jamais deux histoires différentes sur le même argent.",
                "Quelqu'un qui n'a pas accès à la caisse — la comptabilité, par exemple — peut quand même enregistrer son virement sur la facture. Il ne verra jamais le solde de la caisse et ne pourra pas le modifier.",
                ...
                "Les 4 coins n'ont pas besoin de former un rectangle : placez-les sur les vrais coins de la feuille, même si la photo est prise de biais. Une feuille pliée ou froissée ressortira un peu ondulée — mettez-la à plat avant la photo.",
                "Sur ordinateur, « Scanner la facture » ouvre une image déjà enregistrée (photo ou capture d'écran) au lieu de l'appareil photo.",
                "Ne confondez pas avec « Facturation », qui est l'inverse : les factures que l'entreprise envoie à ses clients.",
            ],
            "en": [
                "Recording an invoice moves no money: it is a debt, not a cost. Only payments made by the cash box touch its balance, and those are entered on the Expenses page.",
                "A payment that came from the box reads \"Cash box\" and cannot be edited from the invoice: the cost itself has to be corrected. That is what keeps the bill and the box from telling two different stories about the same money.",
                "Someone with no access to the cash box — accounting, say — can still record their transfer on the invoice. They never see the box's balance and cannot change it.",
                ...
                "The 4 corners do not have to make a rectangle: put them on the sheet's real corners, even if the photo was taken at a slant. A folded or crumpled sheet will come out slightly wavy — lay it flat before the photo.",
                "On a computer, \"Scan the invoice\" opens a saved image (a photo or a screenshot) instead of the camera.",
