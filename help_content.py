    ...
    },
    {
        ...
        "steps": {
            "fr": [
                ...
                "Choisissez la flotte concernée, ou « Aucune » si la dépense est une dépense de société — visible par toute personne ayant accès à la page.",
            ...
            "en": [
                ...
                "Pick the fleet the cost belongs to, or \"None\" if it is a company expense — visible to anyone with access to the page.",
        ...
        "tips": {
            "fr": [
                ...
                "Le rapport suit les filtres de la page : la période « du / au » et la flotte. La page s'ouvre sur le mois en cours ; videz une date pour ouvrir ce côté, ou cliquez « Toutes périodes ».",
            ...
            "en": [
                ...
                "The report follows the page's filters: the from/to period and the fleet. The page opens on the current month; clear one date to open that side, or click \"All periods\".",
