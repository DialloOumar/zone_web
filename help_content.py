    ...
    },
    {
        ...
        "steps": {
            "fr": [
                ...
                "Un fournisseur qui vous loue des engins : cochez « Fournisseur de machines » sur sa fiche et cochez ses machines. Dans l'onglet Fournisseurs, « Saisies de ses machines » ouvre la saisie quotidienne filtrée sur lui — et le bouton Imprimer de cette page sort la liste des heures et trajets à son nom, pour vérifier sa facture.",
            ...
            "en": [
                ...
                "A supplier that leases engines to you: tick \"Machine supplier\" on its card and tick its machines. On the Suppliers tab, \"Its machines' entries\" opens the daily entries filtered to it — and that page's Print button gives the list of hours and trips under its name, to check its bill.",
