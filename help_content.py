    ...
    },
    {
        ...
        "steps": {
            "fr": [
                ...
                "(Optionnel) « Quantité » : le nombre d'articles achetés, quand la dépense en concerne — 5 ampoules, 2 bidons. C'est une mention sur la dépense, le stock de pièces n'en tient pas compte.",
            ...
            "en": [
                ...
                "(Optional) \"Quantity\": how many items were bought, when the cost is for some — 5 bulbs, 2 drums. It is a note on the expense; the parts stock does not count it.",
