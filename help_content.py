...
HELP_SECTIONS = [
    ...
    },
    {
        ...
        "tips": {
            ...
            "Chaque filtre est un menu déroulant : ouvrez-le et cochez plusieurs sites ou plusieurs véhicules à la fois. Il n'y a pas de bouton à presser — le filtre s'applique dès que vous refermez le menu, et une date dès que vous la choisissez.",
            ...
            "Each filter is a dropdown: open it and tick several sites or several vehicles at a time. There is no button to press -- the filter applies as soon as you close the menu, and a date as soon as you pick it.",
