...
HELP_SECTIONS = [
    ...
    },
    {
        ...
        "tips": {
            ...
            "Chaque filtre est un menu déroulant : ouvrez-le et cochez plusieurs sites ou plusieurs véhicules à la fois. Il n'y a pas de bouton à presser : cochez ce que vous voulez et la liste se met à jour toute seule un instant après. Une date s'applique dès que vous la choisissez.",
            ...
            "Each filter is a dropdown: open it and tick several sites or several vehicles at a time. There is no button to press: tick what you want and the list updates on its own a moment later. A date applies as soon as you pick it.",
